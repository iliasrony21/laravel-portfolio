                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="about__skill__item">
                            ...
                            <div class="progress">
                                <div class="progress-bar" role="progressbar" style="width: 70%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"><span class="percentage">50%</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="about__skill__item">
                            ...
                            <div class="progress">
                                <div class="progress-bar" role="progressbar" style="width: 60%;" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"><span class="percentage">80%</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="about__skill__item">
                            <h5 class="title">BOOTSTRAP/TAILWIND</h5>
                            <div class="progress">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="about__education__item">
                            ...
                            <p>I have completed my S.s.c in sos Herman Gmeiner college,Bogura.My Result is GPA-5.00</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="about__education__item">
                            ...
                            <p>I have completed my H.s.c in Biam Model School and College,Bogura.My Result is GPA-5.00</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="about__education__item">
                            <h3 class="title">B.Sc in Computer Science and Engineering(CSE)</h3>
                            <span class="date">2018 – 2022</span>
                            <p>I have completed my B.Sc in Daffodil International University,Dhaka.My Result is CGPA-3.71</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="about__education__item">
                            ...
                            <p>I have completed this course in PencilBox training Institude(SEIP),dhaka</p>
                        </div>
                    </div>
                </div>
            </div>
